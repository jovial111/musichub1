...
if(isset($_POST['login']))
  {
    ...
    $query=mysqli_query($con,"select id from tbluser where  email='$user' && pwd='$password' ");
...
<html lang="en">
	<head>
		...
		<meta name="description" content="Listen App - Online Music App ">
						...
						<div class="col-xl-5 col-lg-7 col-md-9 col-sm-11 mx-auto">
							<div class="card">
								...
								<p class="fs-6">Welcome back! login with your data that you entered during registration</p>
								 ...
								 <form action="#" class="mt-5" method="post" name="login">
	
									<div class="mb-3"><label for="username" class="form-label fw-medium">Email</label> <input type="text" id="username" name="username" class="form-control" required></div><div class="mb-2"><label for="password" class="form-label fw-medium">Password</label> <input type="password" id="password" name="password" class="form-control" required></div>

	
									<div class="mb-5"><input type="submit" class="btn btn-primary w-100" name="login" value="Login"></div><p>Not registered yet?<br><a href="register.php" class="fw-medium external">Register</a></p>
								</form>
							</div>
						</div>
					</div>
	...
	<script src="js/plugins.bundle.js"></script><script src="js/scripts.bundle.js"></script>
	</body>
