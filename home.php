...
if(isset($_POST['submit']))
  {
    ...
    if ($query) {
     ...
     $command = escapeshellcmd('python emotionpred.py');
	...
	<div id="wrapper">
		<aside id="sidebar">
			...
			<div class="sidebar-body" data-scroll="true">
				...
				<ul class="navbar-nav">
					<li class="nav-item"><a href="home.php" class="nav-link d-flex align-items-center active" target="_self"><i class="ri-home-4-line fs-5"></i> <span class="ps-3">Home</span></a></li>
					...
					<!--<li class="nav-item"><a href="albums.html" class="nav-link d-flex align-items-center" target="_self"><i class="ri-album-line fs-5"></i> <span class="ps-3">Albums</span></a></li>
					<li class="nav-item"><a href="artists.html" class="nav-link d-flex align-items-center" target="_self"><i class="ri-mic-line fs-5"></i> <span class="ps-3">Artists</span></a></li>-->
			...
			<div class="sidebar-foot">
				<a href="add-music.php" class="btn btn-primary d-flex" target="_self"><div class="btn__wrap"><i class="ri-music-fill"></i> <span>Add Music</span></div></a>
			</div>
		</aside>
		<header id="header">
			<div class="container">
		...
		<main id="page_content">
			...
			<div class="section__head">
				<div class="flex-grow-1">
					<span class="section__subtitle">Listen top Songs</span><h3 class="mb-0">Top <span class="text-primary">Songs</span></h3>
				</div>
				<a href="music.php" class="btn btn-link">View All</a>
			</div>
			<?php 
			$emotion="";
			$ret1=mysqli_query($con,"select * from tblsearch order by id desc limit 1");
			while ($row1=mysqli_fetch_array($ret1)) {
				  $emotion = $row1['emotionrecognized'];
